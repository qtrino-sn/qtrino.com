...
+  '<li><a id="academy" href="/qtrino-academy.html">Academy</a></li>'
+  '<li><a id="discovery" href="/qtrino-discovery.html">Discovery</a></li>'
+  '<li><a id="technology" href="/qtrino-technology.html">Technology</a></li>'
...
+'<div class="services">'
+  '<h3>Services</h3>'
+  '<a href="/qtrino-academy.html">Qtrino Academy</a>'
+  '<a href="/qtrino-discovery.html">Qtrino Discovery</a>'
+  '<a href="/qtrino-technology.html">Qtrino Technology</a>'
+'</div>'
+'<div class="web-links">'
+  '<h3>Others</h3>'
